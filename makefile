...
OBJ-OOT-0.9           = $(OBJ-gz-oot-0.9) $(OBJ-gz-oot-0.9-vc)
...
ELF-OOT-0.9           = $(ELF-gz-oot-0.9) $(ELF-gz-oot-0.9-vc)
...
$(OBJ-OOT-0.9)        : ALL_CPPFLAGS         += -DZ64_VERSION=Z64_OOT09
...
$(ELF-OOT-0.9)        : ALL_LDLIBS           += -loot-0.9
